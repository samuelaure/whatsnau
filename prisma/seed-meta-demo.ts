  ...
  const demoLeads = [
    ...
    // INTERESTED Leads (4)
    {
      ...
      metadata: JSON.stringify({
        ...
        city: 'Sevilla',
        interest: 'Automatización de reservas',
      }),
    ...
    },
    {
      ...
      tenantId,
      metadata: JSON.stringify({
        business: 'Peluquería Estilo Laura',
        city: 'Málaga',
        interest: 'Recordatorios automáticos',
      }),
    ...
    },
    {
      ...
      tenantId,
      metadata: JSON.stringify({
        business: 'Inmobiliaria Ruiz Properties',
        city: 'Zaragoza',
        interest: 'Calificación de leads',
      }),
    ...
    // DEMO Leads (3)
    {
      ...
      demoMinutes: 10,
      metadata: JSON.stringify({
        business: 'Taller Mecánico Gómez',
        city: 'Granada',
    ...
    },
    {
      ...
      demoMinutes: 10,
      metadata: JSON.stringify({
        business: 'Clínica Veterinaria PetCare',
        city: 'Murcia',
        services: 'Consultas, Urgencias',
      }),
    ...
    },
    {
      ...
      demoMinutes: 10,
      metadata: JSON.stringify({
        business: 'Abogados Torres & Asociados',
        city: 'Alicante',
        services: 'Civil, Mercantil',
      }),
      lastInteraction: new Date(Date.now() - 1 * 60 * 1000), // 1 min ago
    },
    ...
    // CLIENT Leads (2)
    {
      ...
      tenantId,
      metadata: JSON.stringify({
        business: 'Consultoría Empresarial Romero',
        city: 'Pamplona',
        package: 'Premium',
      }),
    ...
    },
    {
      ...
      tenantId,
      metadata: JSON.stringify({
        business: 'Centro de Formación TechSkills',
        city: 'Valladolid',
        package: 'Enterprise',
      }),
